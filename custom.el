...
;; then enter the text in that file's own buffer." 131 135
 ...
 '(package-selected-packages
   (quote
    (circe zenburn-theme better-defaults ergoemacs-mode yesql-ghosts yasnippet whitespace-cleanup-mode visual-regexp string-edit smartparens simple-httpd restclient prodigy paredit nodejs-repl move-text markdown-mode magit ido-vertical-mode ido-at-point htmlize highlight-escape-sequences guide-key groovy-mode gist flycheck-pos-tip flycheck-clojure flx-ido fill-column-indicator elisp-slime-nav dockerfile-mode dired-details css-eldoc clojure-mode-extra-font-locking)))
